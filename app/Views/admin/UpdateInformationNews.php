...
<body class="gray-bg">
    ...
    <section class="main-block light-bg" id="update-news-componet">
        <div class="container">
            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <textarea id="textMessage" v-model="news.details" class="form-control"
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <div class="input-daterange input-group" id="datepicker">
                                                    <input type="date" v-model="news.date_time_start_valid" class="form-control-sm form-control" name="start"/>
                                                    <span class="input-group-addon">ถึง</span>
                                                    <input type="date" v-model="news.date_time_end_valid" class="form-control-sm form-control" name="end"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mb-2">
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <img class="img-up" v-if="news.image_name == ''" src="../asset/img/MAIN.png" id="image-preview">
                                                <img class="img-up" v-else="news.image_name != ''" v-bind:src="'../resource/image/news/' + news.image_name" id="image-preview">
                                            </div>
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" v-model="news.video_youtube" class="form-control form-control-lg form-control-a"
                                                    placeholder="url youtube" >
                                            </div>                                          
                                            <button type="button" class="btn btn-primary1 block full-width m-b"
                                                @click="updateNews()">อัพเดตข้อมูล</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <script src="../asset/js/custom_js/update-news-component.js"></script>
</body>
