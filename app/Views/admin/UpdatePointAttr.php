...
<body class="gray-bg">
    ...
    <section class="main-block light-bg" id="update-point-attr-component">
        <div class="container">
            <div class="row">
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group">
                                                <h5 class="" style="color: #3E8B9B; font-family: Cloud-Bold;">
                                                    {{attr_point.attr_name}}	</h5>
                                            </div>
                                            <div class="form-group">
                                                <h5 class="" style="color: #3E8B9B; font-family: Cloud-Bold;">
                                                    ข้อมูล {{attr_point.point_name}}	</h5>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-lg form-control-a"
                                                    placeholder="ตักบาตรข้าวเหนียว" v-model="attr_point.point_name">
                                            </div>
                                        </div>
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <textarea id="textMessage" class="form-control"
                                                    ...
                                                    required="" v-model="attr_point.details"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <button type="button" class="btn btn-primary1 float-right" style="margin-bottom: 5px;"
                                                    onclick="document.getElementById('audio-file-input').click()">แก้ไขไฟล์เสียงคำบรรยาย</button>
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <button type="button" class="btn btn-primary1 float-right"
                                                    style="margin-bottom: 5px;" onclick="document.getElementById('img-file-input').click()">แก้ไขรูปภาพ</button>
                                                <label class="color-bb">** กรณีอัพเดตไฟล์รูปภาพสามารถเพิ่มรูปภาพได้ 1 ภาพ **</label>
                                                <img class="img-up" v-if="attr_point.image_file_name == ''" src="../asset/img/MAIN.png" id="image-preview">
                                                <img class="img-up" v-else="attr_point.image_file_name != ''" v-bind:src="'../resource/image/' + attr_point.image_file_name" id="image-preview">
                                            </div>
                                            <button type="button" class="btn btn-primary1 block full-width m-b" @click="updateData()" >อัพเดตข้อมูล</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="ibox-content-hhh">
                    ...
                    <div class="form-group" style="padding: 5px 15px 0px;">
                        <p class="text-back text-center">ได้ทำการอัพเดต แก้ไขข้อมูลเรียบร้อยเเล้ว สามารถตรวจเช็คจากหน้า VR ได้เลย</p>
    ...
    <script src="../asset/js/custom_js/update-point-attr-component.js"> </script>
</body>
